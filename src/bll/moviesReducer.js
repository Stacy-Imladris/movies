...
export const moviesActions = {
    ...
    setTotalMoviesCount: (totalMoviesCount) => ({type: 'MOVIES/SET_TOTAL_MOVIES_COUNT', payload: {totalMoviesCount}}),
    setCurrentPage: (currentPage) => ({type: 'MOVIES/SET_CURRENT_PAGE', payload: {currentPage}}),
    toggleIsLoading: (isLoading) => ({type: 'MOVIES/TOGGLE_IS_LOADING', payload: {isLoading}}),
    setError: (error) => ({type: 'MOVIES/SET_ERROR', payload: {error}}),
    setTitleForSearch: (titleForSearch) => ({type: 'MOVIES/SET_TITLE_FOR_SEARCH', payload: {titleForSearch}}),
}
